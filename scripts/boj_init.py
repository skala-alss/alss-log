...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("lang", choices=["cpp","py","java","c++","cpp17","python"], help="언어")
...
def normalize_lang(lang: str) -> str:
    if lang in ["cpp","c++","cpp17"]: return "cpp"
...
case "$ext" in
  cpp)
    ...
    "$gpp" "$pick" -std=c++17 -O2 -pipe -static -s -o "$exe"
    run_cmd() { ./main.exe; }
    ;;
  py)
